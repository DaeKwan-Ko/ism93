...
# I wanted to test how lfcShrink can change the FC. LFCs shrinkage can be used to avoid bias in genes with low read coverage
# ref: https://www.biostars.org/p/340269/
...
# It is particularly useful for lowly expressed genes because they have high variability and shrinkage can reduce it. 
```


```{r MA plot}
# In some samples, there were some differences between non-shrink and shrink, especially for those that were lowly expressed
# shrinking is needed? will be used
...
Visualize the data in volcano plots (https://www.bioconductor.org/packages/release/bioc/vignettes/EnhancedVolcano/inst/doc/EnhancedVolcano.html)
